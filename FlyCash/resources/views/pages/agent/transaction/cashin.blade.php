        ...
        <div class="col-md-4">
            <div class="card card-user">
                <div class="card-body">
                    ...
                    <input type="text" name="accountnumber" class="form-control{{ $errors->has('accountnumber') ? ' is-invalid' : '' }}" placeholder="{{ __('+8801*********') }}">
                ...
                <div class="card-footer">
                        <button type="submit" class="btn btn-fill btn-primary">{{ __('Cash in') }}</button>
                    </div>
                </div>
            </div>
    </div>
